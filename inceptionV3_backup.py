...
plt.legend()
#plt.show()
plt.savefig('100_epochs_LossVal_loss_Inceptionv3_Solo_SISO')
...
plt.legend()
#plt.show()
plt.savefig('100_epochs_AccVal_acc_Inceptionv3_Solo_SISO')

#save our model
model.save('100_epochs_Inceptionv3_Solo_SISO.h5')

#save the history of our model
hist_df = pd.DataFrame(r.history) 
hist_csv_file = 'history_100epochs_Inceptionv3_Solo_SISO.csv'
